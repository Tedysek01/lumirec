          ...
          <button
            ...
            className={cn(
              ...
              isSelected
                ...
                : 'bg-secondary border-border/40 text-muted-foreground hover:bg-accent hover:border-border/60 hover:text-foreground',
          ...
          >
            <div
              className={cn(
                ...
                isSelected ? 'bg-primary/20 text-primary' : 'bg-secondary'
              )}
            >
              {option.icon}
            </div>
